...
C# · Unity 3D · Visual Studio · .NET / WPF · Meta Quest · Git / GitHub / Plastic SCM · Audacity · Confluence · Jira · Scrum
...
- Tested and evaluated the performance using Meta's OVR Metrics Tool
...
The existing tutorial flow was replaced with a new concept consisting of a guided tutorial and a separate recycling section. We wanted to provide a clearer and more accessible introduction to the VR application.
...
#### 3. Audio & Sound Integration

I worked closely with another developer on the audio system used throughout teora® mind. While the underlying sound system was developed by my colleague, we collaborated on its design and integration into the application.

My main responsibility was the **selection, preparation and integration of the audio content**.

**My contribution:**
- Researched and selected suitable CC0 sound effects
- Edited and prepared audio assets using Audacity
- Organized sounds based on material and interaction type
- Integrated sound components into scenes and reusable prefabs
- Configured sound behavior for interactive objects and collisions
...
- Implementing the **level structure, scene setup and in-game tablet UI**
...
- Developing interactive shootables and their individual behaviors, including:
  ...
  - **Jack-in-the-box** with opening/closing lid, physics-based jumping behavior and reactions when hit
...
- Working with Unity physics, rigidbodies, joints and transforms to create interactive object behavior
- Collaborating with artists to integrate and iterate on visual effects and gameplay feedback

The minigame was designed as a self-contained interactive experience within teora® mind.

[Gameplay Video]

### Additional Contributions

Beyond the showcases above, I also contributed to areas such as:

- Localization and multilingual content
- Unity and SDK updates
- Reusable prefabs and shared components
